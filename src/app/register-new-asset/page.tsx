...
export default function RegisterNewAssetPage() {
  ...
  const [autoGeneratedTagNumber, setAutoGeneratedTagNumber] = useState("");
  ...
  const transformFormDataToApiRequest = (
    ...
    return {
      ...
      operatingSystemVersion: data.operatingSystemVersion || undefined,
      releaseVersion: data.releaseVersion || undefined,
      eolEoslDate: data.eolEoslDate || undefined,
      locationStatus: data.locationStatus || undefined,
    };
  };
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    label="Brand"
                    placeholder="Enter brand (e.g., Dell, HP, Apple)"
                    error={errors.brand}
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    ...
                    error={errors.operatingSystemVersion}
                    touched={touchedFields.operatingSystemVersion}
                  ...
                  <FormField
                    ...
                    touched={touchedFields.releaseVersion}
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    label="EOL/EOSL Date"
                    type="date"
                    error={errors.eolEoslDate}
                    touched={touchedFields.eolEoslDate}
                    {...register("eolEoslDate")}
                    description="End of Life / End of Service Life date"
                  />
